...
const steps = [
  { icon: Building2, title: "Company Profile", description: "Tell us about your organization" },
  { icon: Zap, title: "Output Goals", description: "Define your energy objectives" },
  { icon: Shield, title: "Data Integration", description: "Secure connection setup" }
] as const;
    ...
    <section className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-background/95 px-4 py-8 md:py-12">
      <div className="container max-w-4xl">
        <div className="space-y-6 md:space-y-8">
          ...
          {/* Main Content */}
          <Card className="relative border-muted/30 shadow-lg">
          ...
          <footer className="text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-muted/30 px-4 py-2 text-sm text-muted-foreground backdrop-blur-sm">
