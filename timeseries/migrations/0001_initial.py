        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alarm_code",
                    models.CharField(
                        help_text="Code representing the type of alarm", max_length=50
                    ),
                ),
                (
                    "node_id",
                    models.IntegerField(
                        help_text="Node identifier associated with the alarm"
                    ),
                ),
                (
                    "time_on",
                    models.DateTimeField(
                        help_text="Timestamp when the alarm was activated"
                    ),
                ),
                (
                    "time_off",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["time_on", "node_id"],
                        name="timeseries__time_on_3f0b65_idx",
                    ),
                    models.Index(
                        fields=["content_type", "farm_id"],
                        name="timeseries__content_da0174_idx",
                    ),
                ],
                "constraints": [
